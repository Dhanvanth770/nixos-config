  ...
  wayland.windowManager.hyprland = {
    ...
    extraConfig = ''
      ...
      animations {
          ...
          bezier = slideup, 0.05, 0.9, 0.1, 1.05        
          ...
          animation = windows, 1, 5, slideup, slidefadevert
      }
      ...
      bind = , XF86Launch2, exec, victus-control
      ...
      layerrule = animation slidefadevert, match:namespace ^(rofi)$
