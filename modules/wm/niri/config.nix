...

{
  ...
  home.file.".config/niri/config.kdl" = {
    text = ''
      ...
      window-rule {
          match title="victus-control"
          open-floating true
          default-column-width { fixed 882; }
      ...
      binds {
          ...
          Super+Shift+L hotkey-overlay-title="Lock the Screen: noctalia-lock" { spawn "noctalia-shell" "ipc" "call" "lockScreen" "lock"; }
          ...
          XF86Launch2 { spawn "victus-control"; }
          XF86Calculator { spawn "org.gnome.Calculator"; }
